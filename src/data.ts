...
export const DB: DemeEntry[] = [
  ...
  { code:"283", type:"reach", label:"つばさ", desc:"GG当選濃厚。別名・翼目。翼をください。この台から飛び立ちたい。でも当たらなきゃ飛べない。頑張れ！", cond:null },
  ...
  { code:"S0S", type:"joke", label:"救難目", desc:"<ジョークMODE>救難目。目撃したら、どんな差枚圏からでも神の手が降りてきて救ってくれます。しかし恐らく目にすることはないでしょう…大丈夫。神は君のレバーに宿る。", cond:null },
  ...
  { code:"840", type:"joke", label:"走れ目", desc:"<ジョークMODE>走れ目。閉店まであと30分。全ツッパか撤退か。走れ、メロスのごとく。ただしメロスは無一文ではなかった。", cond:null },
  { code:"314", type:"joke", label:"裏パイ目", desc:"<ジョークMODE>裏パイ目。081目の裏。表が煩悩ならこっちは理性かと思いきや、受験勉強を始めた途端にムラムラするように結局こちらも煩悩なのである。嗚呼、奥深き◯ッパイ。", cond:null },
  { code:"651", type:"joke", label:"", desc:"<ジョークMODE>なんて仕打ちだ…そう思っている時になぜか出現する。もうお前は見たくない。あっちいけ！", cond:null },
  { code:"141", type:"joke", label:"ミートボール目", desc:"<ジョークMODE>ミートボール目。今もあるのかな。イシイのおべんとくん♫", cond:null },
